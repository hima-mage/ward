...
window.addEventListener('load', DrawPlaceholder(img,ctx,"#fff",'eid-4.jpg',390,880)); 
...
window.addEventListener('load', DrawPlaceholder(img1,ctx1,"#000",'eid-5.jpg',550,643));
...
canv.drawImage(photo,0,0 , 1000,1000);
